...
exclude_patterns = [
    ...
    "changelog.md",
    "reference/**",
    "technical/diagnostics.md",
    "technical/methylotrophic-methanogenesis.md",
    "technical/reaction-network-reference.md",
    "technical/reaction-network-tables/**",
    "technical/reaction-networks/**",
    "technical/redox-chemistry-coupling.md",
    "technical/water-column-gas-transport.md",
